...
export const registerUser = (registerData) => {
  ...
  return async (dispatch) => {
    try {
      ...
      await axios.post('/auth/register/', {email: registerData.email, firstName: registerData.firstName, lastName: registerData.lastName, password: registerData.password }, { headers: { "Access-Control-Allow-Origin": "*", } } );
