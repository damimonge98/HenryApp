                      ...
                      <Fragment>
                        <div id="openModal" title="close" class="modalDialog">
                          <div><a href="#close" onClick={() => { setModalState(false); }} class="close">X</a>
                            ...
                            <form>
                              <p>
                                Nombre  <input onChange={onChangeHandler} name="firstName" placeholder={infoUser.firstName} value={user.name}></input>
                              </p>
                              <p>
                                Apellido  <input onChange={onChangeHandler} name="lastName" placeholder={infoUser.lastName} value={user.name}></input>
                              </p>
                              <p>
